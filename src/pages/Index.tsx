...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <main className="px-4 py-6 max-w-4xl mx-auto space-y-6">
        ...
        <section className="bg-white rounded-2xl border border-gray-200 p-4 sm:p-6 shadow-sm">
          <div className="mb-6">
            <div className="flex items-center justify-between mb-2">
              <h2 className="font-bold text-gray-900 text-lg">Selecione 15 números</h2>
              <div className="flex items-center gap-2">
                ...
                <span className={`text-sm font-bold px-3 py-1 rounded-full ${selectedNumbers.length === 15 ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700'}`}>
                  {selectedNumbers.length}/15
                </span>
              </div>
            </div>
            <p className="text-sm text-gray-600">
              Use as estratégias acima ou selecione manualmente
            </p>
          </div>
          ...
          {selectedNumbers.length > 0 && (
            <div className="mt-6 pt-6 border-t border-gray-100">
              <div className="flex items-center justify-between mb-4">
                <p className="text-sm font-medium text-gray-900">Análise da sua seleção:</p>
                <div className="flex items-center gap-2">
              ...
              <div className="mt-4">
                <p className="text-sm text-gray-600 mb-2">Seus números:</p>
                <div className="flex flex-wrap gap-1.5">
                  {selectedNumbers.map((num) => (
                    <span
                      key={num}
                      className="px-2.5 py-1 bg-gradient-to-r from-primary to-primary/90 text-white text-xs font-bold rounded-full shadow-sm"
                    >
          ...
          <div className="flex flex-col sm:flex-row gap-3 mt-6">
            ...
            >
              ...
              {selectedNumbers.length === 15 ? 'Simular Agora!' : 'Selecione 15 números'}
            </Button>
            <Button
              variant="outline"
              onClick={handleClear}
              ...
              <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-600">Você acertaria o prêmio principal!</p>
                      </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-600">Excelente resultado!</p>
                      </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-600">Boa pontuação!</p>
                      </div>
                ...
                <div className="bg-gradient-to-r from-blue-50/50 to-blue-50/30 rounded-xl border border-blue-200 p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-bold text-blue-900 text-sm mb-1">Recomendação Baseada na Análise</h3>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-gray-50 p-3 rounded-lg">
                  ...
                  <p className="text-lg font-bold text-gray-900">
                    {results.match15.length > 0 ? '15 acertos' : 
                     results.match14.length > 0 ? '14 acertos' : 
                     results.match13.length > 0 ? '13 acertos' : 'Nenhum'}
                  </p>
        ...
        {!hasSimulated && selectedNumbers.length === 0 && (
          <div className="bg-gradient-to-r from-primary/5 to-primary/10 rounded-xl border border-primary/20 p-4 text-center">
            ...
            <p className="text-sm text-gray-600">
              Use as <span className="font-bold text-primary">Estratégias Inteligentes</span> acima para 
              gerar combinações baseadas em análise estatística de {lotofacilResults.length} concursos.
            </p>
          </div>
        )}
      </main>
      ...
      {selectedNumbers.length > 0 && selectedNumbers.length < 15 && (
        <div className="fixed bottom-6 right-6 sm:hidden">
          <Button
            ...
            className="rounded-full w-14 h-14 shadow-lg bg-gradient-to-br from-primary to-primary/90"
          >
            <span className="text-lg font-bold">{selectedNumbers.length}/15</span>
          </Button>
        </div>
      )}
    </div>
